								...
								<div class="product-box mb-md-20">
									<div class="product-img">
										<a href="{{route('product_details_page',['product_id'=>$products->product_id])}}">
											<img src="{{asset($products->product_image)}}" class="img-fluid full-width default-img" alt="product-img" style="height: 250px;width:350px">
											<img src="{{asset($products->product_image)}}" class="img-fluid full-width hover-img" alt="product-img" style="height: 250px;width:350px">
										</a>
									...
									<div class="product-caption text-center">
										<h6 class="product-title fw-600 mt-0"><a href="{{route('product_details_page',['product_id'=>$products->product_id])}}" class="text-color-primary">{{$products->product_name}}</a></h6>
										<div class="ratings">
										...
										<div class="product-money mt-10"> <span class="text-color-primary fw-600 fs-16">{{$products->product_price}}৳</span>
