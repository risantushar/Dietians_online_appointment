                        ...
                        <div class="swiper-container gallery-top swiper-container-initialized swiper-container-horizontal">
                            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                <div class="swiper-slide swiper-slide-active" style="width: 510px; margin-right: 15px;">
                                    <a href="#" class="popup">
                                        <img src="{{asset($medicin_details->medicin_image)}}" class="img-fluid full-width" alt="slider">
                                    </a>
            ...
            <div class="col-lg-7">
                <div class="shop-detail-contents mb-md-40 mt-md-40">
                    <div class="shop-detail-content-wrapper">
                        <h3 class="text-theme-primary price-tag">{{$medicin_details->medicin_name}}-({{$medicin_details->medicin_mg}}<sub>mg</sub>)</h3>
                    </div>
                    ...
                    <div class="price">
                        <h4 class="text-custome-black">Medicin Price: <span class="text-light-white fw-400 fs-16">{{$medicin_details->medicin_price}} ৳</span></h4>
                    </div>
                    <div class="product-full-des mb-20 mt-20">
                        <h3>Medicin Description</h3>
                    </div>
                    <div class="product-full-des mb-20">
                       
                        <p class="mb-0">{{$medicin_details->medicin_description}}</p>
                    </div>
                    {{-- <div class="availibity mt-20">
                        <p class="text-custom-black fw-600">Avability: <span class="text-success ml-2">In Stock</span></p>
                    </div> --}}
                    <form action="{{route('add_to_cart_medicin')}}" method="post">
                        @csrf
                        <input type="hidden" name="medicin_id" id="" value="{{$medicin_details->medicin_id}}">
                    ...
                    <div class="shop-bottom">
                        <div class="shop-meta mt-20">
                            ...
                            <ul class="list-inline ml-2">
                                @php
                                    $medicinCategoryName=DB::table('medicin_categories')
                                    ->where('id',$medicin_details->medicin_category)
                                    ->first();
                                @endphp
                                <li class="list-inline-item"><a>{{$medicinCategoryName->medicin_category_name}}</a>
                                </li>
                            </ul>
                        </div>
