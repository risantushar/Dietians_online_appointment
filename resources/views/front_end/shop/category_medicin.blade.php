			...
			<div class="row">
				...
				<div class="col-xl-9 col-lg-8">
					<div class="full-width">
						<div class="row">
                            @foreach($category_medicins as $product)
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
								<div class="product-box mb-md-20">
									<div class="product-img">
										<a href="{{route('medicin_detils_page',['medicin_id'=>$product->medicin_id])}}">
											<img src="{{asset($product->medicin_image)}}" class="img-fluid full-width default-img" alt="product-img" style="height: 250px;width:350px">
											<img src="{{asset($product->medicin_image)}}" class="img-fluid full-width hover-img" alt="product-img" style="height: 250px;width:350px">
										</a>
									...
									<div class="product-caption text-center">
										<h6 class="product-title fw-600 mt-0"><a href="{{route('medicin_detils_page',['medicin_id'=>$product->medicin_id])}}" class="text-color-primary">{{$product->medicin_name}}</a></h6>
										<div class="ratings">
										...
										<div class="product-money mt-10"> <span class="text-color-primary fw-600 fs-16">{{$product->medicin_price}}৳</span>
											{{-- <span class="text-price">$250.00</span> --}}
										</div>
										<div class="cart-hover">
											<a href="{{route('medicin_detils_page',['medicin_id'=>$product->medicin_id])}}" class="btn-cart  fw-600" tabindex="-1">Add To Cart</a>
										</div>
									</div>
								</div>
							</div>
