                ...
                <div class="col-md-7 col-lg-9 col-xl-9">
                  <div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      ...
                      <p class="mb-0"><span><strong id="summary">Price: {{$total=$cartProduct->quantity}} x {{$cartProduct->price}}৳ = {{$total=$cartProduct->quantity*$cartProduct->price}}৳</strong></span></p class="mb-0">
                    </div>
                  </div>
                </div>
              </div>  
          ...
          <div class="mb-3">
            <div class="pt-4">
              ...
              $customer_id = Session::get('customer_id');
                if($customer_id == '') { ?>
              <a href="{{route('customer_login_page')}}" type="button" class="btn btn-primary btn-block">go to checkout</a>
              <?php }else if($customer_id != null) { ?>
                <a href="{{route('shipping_page')}}" type="button" class="btn btn-primary btn-block">go to checkout</a>
              <?php } ?>
