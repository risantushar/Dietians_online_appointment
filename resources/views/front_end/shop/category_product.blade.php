						...
						<div class="main-box padding-20 trending-blog-cat mb-xl-20">
							...
							<ul>
								...
								@foreach($product_categories as $product_category)
									<li class="pb-xl-20 u-line mb-xl-20">
										<a href="{{route('all_product_page',['id'=>$product_category->product_id])}}" class="text-light-black fw-600">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
								<div class="product-box mb-md-20">
									<div class="product-img">
										<a href="{{route('product_details_page',['product_id'=>$products->product_id])}}">
											<img src="{{asset($product->product_image)}}" class="img-fluid full-width default-img" alt="product-img" style="height: 250px;width:350px">
											<img src="{{asset($product->product_image)}}" class="img-fluid full-width hover-img" alt="product-img" style="height: 250px;width:350px">
										</a>
									...
									<div class="product-caption text-center">
										<h6 class="product-title fw-600 mt-0"><a href="{{route('product_details_page',['product_id'=>$products->product_id])}}" class="text-color-primary">{{$product->product_name}}</a></h6>
										<div class="ratings">
										...
										<div class="product-money mt-10"> <span class="text-color-primary fw-600 fs-16">{{$product->product_price}}৳</span>
											{{-- <span class="text-price">$250.00</span> --}}
										</div>
										<div class="cart-hover">
											<a href="{{route('product_details_page',['product_id'=>$products->product_id])}}" class="btn-cart  fw-600" tabindex="-1">Add To Cart</a>
										</div>
									</div>
								</div>
							</div>
